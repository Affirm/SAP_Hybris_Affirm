...
/**
 * Generated class for type <code>AffirmpaymentfulfilmentprocessManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedAffirmpaymentfulfilmentprocessManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, AffirmpaymentfulfilmentprocessConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, AffirmpaymentfulfilmentprocessConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return AffirmpaymentfulfilmentprocessConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, AffirmpaymentfulfilmentprocessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, AffirmpaymentfulfilmentprocessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, AffirmpaymentfulfilmentprocessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, AffirmpaymentfulfilmentprocessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
