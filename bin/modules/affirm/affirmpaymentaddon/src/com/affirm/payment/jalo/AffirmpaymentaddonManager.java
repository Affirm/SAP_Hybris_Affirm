...
import com.affirm.payment.constants.AffirmpaymentaddonConstants;



/**
 * This is the extension manager of the Affirmpaymentaddon extension.
 */
public class AffirmpaymentaddonManager extends GeneratedAffirmpaymentaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AffirmpaymentaddonManager.class.getName());
	 ...
	 */
	public static AffirmpaymentaddonManager getInstance()
	{
		return (AffirmpaymentaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AffirmpaymentaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AffirmpaymentaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AffirmpaymentaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AffirmpaymentaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AffirmpaymentaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
