...
/**
 * This is the extension manager of the Affirmpaymentcore extension.
 */
public class AffirmpaymentcoreManager extends GeneratedAffirmpaymentcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AffirmpaymentcoreManager.class);
	 ...
	 */
	public static AffirmpaymentcoreManager getInstance()
	{
		return (AffirmpaymentcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AffirmpaymentcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AffirmpaymentcoreManager() // NOPMD 
	{
		LOG.debug("constructor of AffirmpaymentcoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AffirmpaymentcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AffirmpaymentcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
