                ...
                <div class="row affirm-checkout">
                    <div class="col-sm-6">
                        ...
                        <multiCheckout:checkoutSteps checkoutSteps="${checkoutSteps}" progressBarId="${progressBarId}">
                            <c:url var="affirmAddressFormUrlFull" value="${affirmAddressFormUrl}" />

                            <c:if test="${not empty paymentFormUrl or not empty affirmAddressFormUrl}">
                                <div class="checkout-paymentmethod">
                                    <div class="checkout-indent">
                                        ...
                                        <div class="headline"><spring:theme code="checkout.multi.paymentMethod"/></div>
                                            ...
                                            <spring:theme code="payment.mode.card"/> <input type="radio" value="card" class="js-payment-mode-selector" name="group1"  data-show=".js-card-payment" data-hide=".js-affirm-payment" ">

                                            <c:if test="${not empty affirmAddressFormUrl}">
                                                <spring:theme code="payment.mode.affirm"/> <input type="radio" value="affirm" class="js-payment-mode-selector" name="group1"  data-show=".js-affirm-payment"  data-hide=".js-card-payment" ">
                                            </c:if>
                                        ...
                                        <c:if test="${not empty affirmAddressFormUrlFull}">
                                            <form:form id="affirmAddressForm" class="js-affirm-payment "  name="affirmAddressForm" commandName="affirmAddressForm" action="${affirmAddressFormUrlFull}" method="POST" data-modalmode="${affirmModalMode}" data-vcnmode="${affirmVcnMode}">
                                                ...
                                                <div id="affirmBillingCountrySelector" data-address-code="${fn:escapeXml(cartData.deliveryAddress.id)}" data-country-iso-code="${fn:escapeXml(cartData.deliveryAddress.country.isocode)}" data-display-title="false" class="clearfix">

                                                    <div id="affirmUseDeliveryAddressData"
                                                        data-titlecode="${fn:escapeXml(deliveryAddress.titleCode)}"
                                                        data-firstname="${fn:escapeXml(deliveryAddress.firstName)}"
                                                        data-lastname="${fn:escapeXml(deliveryAddress.lastName)}"
                                                        data-line1="${fn:escapeXml(deliveryAddress.line1)}"
                                                ...
                                                <div id="affirmBillingAddressForm" class="billingAddressForm">
                               ...
                               <button type="button" class="js-affirm-payment btn btn-primary btn-block checkout-next js-submit_affirmForm"><spring:theme code="checkout.multi.paymentMethod.continue"/></button>
                               <button type="button" class="js-card-payment btn btn-primary btn-block submit_silentOrderPostForm checkout-next"><spring:theme code="checkout.multi.paymentMethod.continue"/></button>
                            </c:if>
